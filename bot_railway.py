...
class TelegramBot:
    ...
    def handle_message(self, update):
        ...
        if text.startswith('/'):
            ...
            if command == 'start':
                welcome_msg = """𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙃𝙤𝙡𝙞𝙙𝙖𝙮 𝘽𝙤𝙩!
...
𝙉𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣𝙨 𝙘𝙤𝙢𝙚 24 𝙝𝙤𝙪𝙧𝙨 𝙗𝙚𝙛𝙤𝙧𝙚 𝙝𝙤𝙡𝙞𝙙𝙖𝙮𝙨!"""
                ...
                if chat_id not in USER_CHAT_IDS:
                    ...
                    msg = """𝙋𝙚𝙧𝙛𝙚𝙘𝙩! 𝙔𝙤𝙪'𝙧𝙚 𝙖𝙙𝙙𝙚𝙙 𝙩𝙤 𝙩𝙝𝙚 𝙣𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣 𝙡𝙞𝙨𝙩!

𝙉𝙤𝙬 𝙄'𝙡𝙡 𝙞𝙣𝙛𝙤𝙧𝙢 𝙮𝙤𝙪 𝙖𝙗𝙤𝙪𝙩 𝙝𝙤𝙡𝙞𝙙𝙖𝙮𝙨 𝙤𝙣𝙚 𝙙𝙖𝙮 𝙗𝙚𝙛𝙤𝙧𝙚 𝙩𝙝𝙚𝙞𝙧 𝙖𝙧𝙧𝙞𝙫𝙖𝙡.

𝙏𝙤 𝙪𝙣𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚: /removeme"""
                else:
                    msg = """𝙔𝙤𝙪'𝙧𝙚 𝙖𝙡𝙧𝙚𝙖𝙙𝙮 𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚𝙙! 

𝙔𝙤𝙪'𝙧𝙚 𝙖𝙡𝙧𝙚𝙖𝙙𝙮 𝙧𝙚𝙘𝙚𝙞𝙫𝙞𝙣𝙜 𝙝𝙤𝙡𝙞𝙙𝙖𝙮 𝙣𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣𝙨.
...
𝙏𝙤 𝙪𝙣𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚: /removeme"""
                ...
                if chat_id in USER_CHAT_IDS:
                    ...
                    msg = """𝙔𝙤𝙪'𝙫𝙚 𝙪𝙣𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚𝙙 𝙛𝙧𝙤𝙢 𝙝𝙤𝙡𝙞𝙙𝙖𝙮 𝙣𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣𝙨.

𝙏𝙤 𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚 𝙖𝙜𝙖𝙞𝙣: /addme"""
                else:
                    msg = """𝙔𝙤𝙪'𝙧𝙚 𝙣𝙤𝙩 𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚𝙙 𝙩𝙤 𝙣𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣𝙨.

𝙏𝙤 𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚: /addme"""
                self.send_message(chat_id, msg)
            
            elif command == 'holidays':
                holiday_list = "𝙁𝙪𝙡𝙡 𝙡𝙞𝙨𝙩 𝙤𝙛 𝙝𝙤𝙡𝙞𝙙𝙖𝙮𝙨:\n\n"
                months = {
                ...
                if month_holidays:
                    msg = f"𝙃𝙤𝙡𝙞𝙙𝙖𝙮𝙨 𝙞𝙣 {month_name} {current_year}:\n\n"
                    for day, name in sorted(month_holidays, key=lambda x: int(x[0])):
                        msg += f"📅 {day} {month_name}: {name}\n"
                    msg += f"\n𝙏𝙤𝙩𝙖𝙡 𝙝𝙤𝙡𝙞𝙙𝙖𝙮𝙨: {len(month_holidays)}"
                else:
                    msg = f"𝙉𝙤 𝙝𝙤𝙡𝙞𝙙𝙖𝙮𝙨 𝙞𝙣 {month_name} {current_year}."
...
⏰ 𝙄𝙣 {days_until} {'𝙙𝙖𝙮' if days_until == 1 else '𝙙𝙖𝙮𝙨'}

𝘿𝙤𝙣'𝙩 𝙢𝙞𝙨𝙨 𝙞𝙩! 𝙉𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣 𝙘𝙤𝙢𝙚𝙨 𝙤𝙣𝙚 𝙙𝙖𝙮 𝙗𝙚𝙛𝙤𝙧𝙚!"""
                else:
                    msg = "𝙉𝙤 𝙝𝙤𝙡𝙞𝙙𝙖𝙮𝙨 𝙛𝙤𝙪𝙣𝙙 𝙞𝙣 𝙩𝙝𝙚 𝙣𝙚𝙭𝙩 𝙮𝙚𝙖𝙧."
...
def check_holidays(bot):
    ...
    if tomorrow_key in HOLIDAYS:
        ...
        message = f"""𝙃𝙤𝙡𝙞𝙙𝙖𝙮 𝙩𝙤𝙢𝙤𝙧𝙧𝙤𝙬!

{holiday_name}
📅 {tomorrow.day} {tomorrow.strftime('%B')} {tomorrow.year}

𝘿𝙤𝙣'𝙩 𝙢𝙞𝙨𝙨 𝙞𝙩! 𝙃𝙖𝙥𝙥𝙮 𝙖𝙙𝙫𝙖𝙣𝙘𝙚!"""
